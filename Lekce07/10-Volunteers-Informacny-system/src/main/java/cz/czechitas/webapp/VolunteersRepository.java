...
public class VolunteersRepository {
    ...
    private  List<Volunteer> volunteers = new CopyOnWriteArrayList<>(Arrays.asList(
            ...
            new Volunteer("David","Coller","collerdavid@gmail.com","Študentka medicíny",
            ...
            new Volunteer("Juraj","Milek","trencan24@gmail.com","Študent medicíny",
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.","muž","2020-05-15"),
